    ...
    public override void OnInspectorGUI()
    {
      ...
      true, true, true, true);
        ...
        if ((TypeGo)(serializedObject.FindProperty("DataType").enumValueIndex) == TypeGo.GetTypeD)
        {
            ...
            EditorGUILayout.PropertyField(GetListNoActionShow.FindPropertyRelative("MessageObj"));
            EditorGUILayout.PropertyField(GetListNoActionShow.FindPropertyRelative("ActionName"));
            GUI.backgroundColor = Color.white;
        }
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("CleanInput"));
