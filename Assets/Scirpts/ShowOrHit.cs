...
public class ShowOrHit : MonoBehaviour {
    public static ShowOrHit _Instance;

    public Transform Worning;
    public Text msg;

    public Transform HttpLoading;

    [SerializeField]
    public Transform Password_panle;
    [SerializeField]
    ...
    private void Awake()
    {
        ...
        //Static.Instance.AddValue("huiyuan_id","15734109210");
    }
